...
public class MenuFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        item1.setOnClickListener(new OnClick("Peri Peri Burger ", "50"));
        item2.setOnClickListener(new OnClick("Twisty Peri Peri", "50"));
        item3.setOnClickListener(new OnClick("Twisty Mint", "50"));
        item4.setOnClickListener(new OnClick("Twisty Honey Garlic", "50"));
        item5.setOnClickListener(new OnClick("Twisty Crazy Cheese", "50"));
        item6.setOnClickListener(new OnClick("Twisty Chatpata", "40"));
